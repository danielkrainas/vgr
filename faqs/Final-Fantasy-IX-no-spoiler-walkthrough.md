...
On card arrows: When you find or are given a card, the arrow arrangement on it is randomly determined. You can "reroll" the arrows until they are in a configuration to your liking by reloading your save and getting the card over again. You may want to do this when dealing with rare cards.
...
Side quest: Find the knights (Easy)    Reward: Elixir
...
Event battle 2 in the Evil Forest
HP/MP: 533/1186
Gil/AP: 434/3
Weak: Fire
...
On Ores: Don't blow your Ores for healing. Try to hang onto them because toward the end of the game you can use them to get better items.
...
Tip: This boss counters black magic by returning it. You could just use sword magic.
---
...
Ability note: Aqua Breath misses often.
...
Ability note: Chemist doubles the effectiveness of Potions, Hi-Potions and Ethers.
...
Monsters: Basilisk, Ironite, Magic Vice, Mimic (in residence), Type A (event battle)
...
Note: You automatically get free healing before the battle starts.
...
(1) is connected to "a" by default, to "c" after switching
...
Tip: Float (Lamia's Tiara) finally comes in handy as protection against Earthquake.
...
Note: Only Zidane fights in this battle. Easy steals. Counter, MP Attack, Man Eater and Distract (Reflect Ring) are all effective. Front row for attacking.
---
...
Dojeborn- the most famous artillerist of the realm
...
Hint 4: Check the north side of the continent.
...
Hint 1: The key is figuring out what follows what.
...
Mognet: *from Artemicion to Mogrika
...
New equipment: (statue at the Entrance)
...
Ability note: Master Thief (Thief Gloves) makes it easier to steal the 1/256 items.

+++
Side quest: The Stellazzios
    YOu should be able to turn in two more now (Sagittarius and Capricorn) for 20000 gil and Rosetta Ring.

+++
Side quest: Knight's house (Easy)        Reward: Running Shoes
    Now you can fight an Amudusias. These fights just keep getting easier, and the rewards get better. Auto-Reflect, Demon Killer and MP Attack should do the trick. Auto-Haste, Auto-Regen, Counter, Distract and Accuracy + may also be helpful.

Lv 42
Type: Demon/Flying
HP/MP: 6,578/1,568
Gil/AP: none for this battle
Steal: Hi-Potion, Antidote, Phoenix Pinion, Ether
Weak: Wind        Guard: Earth
Abilities: Horn, Bio, LV4 Holy, Thundara

+++
Mini Game: Chocobo Hot and Cold
    You should be able to find the last two of the six pieces now at either the forest or lagoon. Once you have them, chocograph 20 will appear in your menu.

Chocograph 20 (Easy- 4 hints)

Hint 1: Well, the clue basically tells you where it is.

Hint 2: The two green land masses in the picture are islands.

Hint 3: The gray stuff in the background of the picture is mountains.

Hint 4: The perspective is facing southwest.

Soultion: Search near the two islands at the northeast part of Mist Continent, north of Alexandria Harbor.

Chocograph 22 (Easy- 4 hints)

Hint 1: You need to have found chocograph 20 to get this.

Hint 2: The perspective is facing northwest, but the treasure is on the island in the distance.

Hint 3: The desert that the moogle is referring to is right in the picture.

Hint 4: It's not the desert that Cleyra was in.

Solution: It's on the Likanmack island northeast of the Kelmiera Desert, east from Madain Sari.

Chocobo Hot and Cold
    If you return to the forest or lagoon after finding chocograph 20, Mene will tell you about using the Dead Peppers. To find the third place you can play this mini game, look at the clues on the chocograph pieces. The first piece is sort of an introduction, then there are five pieces with five clues corresponding to five possible locations. When you find a shadow on the sea or ground in the location described on the piece, fly over it with Choco and use a Dead Pepper. (In this new location, there is an optional boss that will be mentioned later.) Once you've visited this place, it will be marked on your map so you can find it easily even if it moves. Here you can find the last three chocographs: 21, 23, and 24. After you've found them, Mene will suggest you look for the unmapped Chocobo's paradise.

Chocograph 21 (Medium- 3 hints)

Hint 1: It's not by the Forgotten Continent.

Hint 2: You may have mistakenly searched here when looking for chocograph 22, because it's very close.

Hint 3: The perspective is south by southeast.

Solution: It's on Korua Island, northeast of the Desert Palace.

Chocograph 23 (Medium- 3 hints)

Hint 1: As you can see, it's a medium sized island with no grass, a forest and a mountain.

Hint 2: It's near both continents that have no grass.

Hint 3: The perspective is facing north.

Solution: It's on the east side of the mountain on Vile Island, between the Outer and Forgotten Continents.

Chocograph 24 (Medium- 3 hints)

Hint 1: Note the brown ground and plateaus in the distance.

Hint 2: This one's not far from where chocograph 23 was.

Hint 3: The perspective is south by southwest.

Solution: It's on Pilkiras Island, northeast of the Qu's Marsh on the Forgotten Continent.

Chocobo's Paradise (Medium- 4 hints)

Hint 1: It's on a medium island. You'll have to use a Dead Pepper to enter.

Hint 2: You may have already come across the island while cruising the sea on Choco.

Hint 3: When Mene told you it was unmapped he really did mean off the map.

Hint 4: Even if it was mapped it'd be hard to see on the map.

Solution: It's at the corner (any corner) of the world. There's a crack in the mountain.

+++
Side quest: Dead Pepper treasures
    You can learn more about Dead Peppers here and find out about even more treasures to discover with them. There are four chocobos who tell you where to find treasure. Each of them will tell you about a mountain crack (speak to them with X) and a foamy spot on the sea (speak with square). One of the attendant gold chocobos offers unlimited Dead Peppers for free.
 Reef chocobo- upper level (must be splashed out of the water)
 Mountain chocobo- upper level
 Ocean chocobo- upper level (must come to him on the pillars)
 Sky chocobo- lower level
    The chocobos clearly explain the location of the treasures. If you are unable to find them there are more detailed descriptions below.

Reef chocobo's treasures
Crack: It's on the east end of the long mountain on the big island north of the Outer Continent, in Cadezil Plains. There's actually nothing you can do here until disc 4.
Foam: It's in the ocean between the Mist and Outer Continents, north of Alexandria.

Mountain chocobo's treasures
Crack: It's on the east side of the mountain on Seatence Ice Field north/south of Chocobo's Lagoon.
Foam: It's in the sea north of the Mountain Path. The long peninsula on the Lost Continent points right at it.

Ability note: Mag Elem Null (Protect Ring) makes all of the character's magic do non-elemental damage.

Ocean chocobo's treasures
Crack: It's in the east central part of the continent, facing east on the lower tier of the plateau. Look for a valley by the sea with a small kidney shaped forest.
Foam: It's in a tiny lagoon east of Qu's Marsh on Lanar Island. Choco will have to squeeze through a small channel to walk here.

Ability note: Fenrir has a different animation and does Wind instead of Earth damage if Eiko is equipped with the Maiden Prayer. Used with Boost, it is an effective way to deal with flying enemies.
    Dragon Breath (Dragon's Hair) does the same damage as the last attack against the enemy; i.e., it mimics the last attack. Although it's targeted at one enemy it hits all of them.
    Flare (Black Robe) is non-elemental, not fire. Flare has always been non-elemental.
    Reflect X2 (Black Robe) causes the character's spells to double in power when they bounce off a Reflected target. Very handy if someone in the party has Auto-Reflect.

Sky chocobo's treasures
Crack: It's in the west central part of the continent, farther south than the last one, facing west on the upper tier of the plateau. Look for a valley by the sea with a larger forest. Unlike the last one the crack is unbranched and harder to see.
Foam: It's outside Quan's dwelling east of Treno but you can't reach it from the sea. To reach it go through the dwelling and to the end of the dock.

+++
Side quest: Quan's dwelling
    While you're here to get the treasure, you can see an extra scene if you bring Vivi and Quina (both must be in the party). Afterward, you can get Running Shoes from the clock.
+++

///Ipsen's Castle///
Basic objective: Get to the top of the castle. Amarant will leave for awhile.

Monsters: Agares & Gargoyle, Cerberus, Tonberry, Veteran
New blue magic: Doom (Veteran)
Useful abilities: Body Temp, Jelly, Locomotion, Beast/Bird/Devil Killer
Note: In this dungeon, weaker weapons do more damage and stronger weapons do less. Magic and other non-attack abilities are unaffected. The Gargoyle is Stone type.

Treasures:
Hall- Dagger, Aquarius (key item)
Small Room- Cat's Claws, moogle (Kumool)
 Mognet: from Mogki to Kumool (Kupo Nut reward)
 Note: If you turn in this Kupo Nut you get a Phoenix Pinion.
Inverted Room (down the pole)- chest you can't reach yet
Stairwell- Broadsword (jump to right from left ladder), Javelin (jump to left from left ladder), Rod (opposite Javelin)
Lift- puzzle leading to Barrette

***
Puzzle: The wall (Very easy)        Reward: Barrette; unlocks lower door in Hall
    This one's simple. Keep trying and you'll get it.
***

Mural Room- Fire Mirror, Earth Mirror, Water Mirror, Wind Mirror (key items)

---
Boss battle at Ipsen's Castle
Lv 46
Type: Flying
HP/MP: 29,186/1,776
Gil/AP: 8,092/11
Steal: Elixir, Mythril Claws, Orichalcon
Weak: Fire, Wind        Half: Ice        Guard: Earth
Abilities: Chop, Blizzaga, Ram
---
Basic objective after the battle: Leave the castle. There are some treasures available now that you couldn't get before.

Inverted Room- Maiden Prayer (fall from upper left trapdoor in Small Room; the two other trapdoors are duds)
Lift (follow path from lower door in Hall)- Air Racket
Sword Room- Golem's Flute

***
Puzzle: The sword (Easy- 3 hints)        Reward: Ancient Aroma

Hint 1: The trick to this puzzle is just figuring out what the objective is. Give it a try, and if you keep moving the bottles incorrectly, you'll be told the clue. From that point it's simple.

Hint 2: "Against the flow of time..." Think clocks.

Hint 3: Consider the way the hands on a clock move.

Solution: Move the bottles counterclockwise.

Ability note: If Odin fails to kill a target (he usually does), then Odin's Sword (Ancient Aroma) causes him to do Wind damage instead.
***

Small Room- Fork, Mage Staff (on top of chandelier; cannot reach them until you've passed through the lower door in the Hall)

Basic objective after exiting: Go back to the inverted room.

Basic objective: Go to each of the Shrines in the instructed order. They aren't marked on your map, but if you need a clue you can ask at the Bridge.
Note: You actually only explore one shrine, and there are no treasures or monsters. Just one boss battle, and you will have only Quina and Zidane in the party.

///Earth Shrine///
Basic objective: Go to the inner room and place the mirror.

***
Puzzle: The moving walls (Very Easy)
    The objective is to get to the other side of the room. All you have to do is hit the button when the Field Icon shows up.
***
---
Boss battle at the Earth Shrine
Lv 54
Type: Demon
HP/MP: 20,756/2,234
Gil/AP: 4,512/
Steal : Avenger, Rubber Suit
Weak: Wind, Holy        Half: Shadow    Absorb: Earth
Abilities: Double Slash, Earthquake, Blizzaga, Thundaga, Firaga

Tip: Auto-Float, the Feather Boots, or even better, Gaia Gear, will deal with Earthquake. Auto Reflect for the rest.
Note: This boss is not undead. You can Eat this punk! (for Earth Shake)
---
Basic objective after the battle: Go to the new location marked on your map.

Note: The next time you'll be able to explore the world map, many locations will be closed off (for no good reason): North Gate, Ice Cavern, Observatory Mountain, Pinnacle Rocks, South Gate, Fossil Roo, Conde Petie, Mountain Path, Esto Gaza and Oeilvert. The weapon shops at Conde Petie, Esto Gaza, and Oeilvert will therefore be inaccessible, and the stock at the Black Mage Village and Daguerreo shops will change, so now is the time if you want to buy any of that equipment.
Tip: I suggest you prepare all of your characters for battle, even those you don't intend to use in the next part. There are some event battles coming up.

+++
Side quest: Catching frogs
    If you've been diligent about catching frogs, it's possible that you're near 99 by now. When you reach it you receive the Gastro Fork, but only after winning a boss battle. It's possible to do this later but I mention it now because there are some great items you can steal from the boss.
...
Abilities: Rolling Attack, Water, Aqua Breath, Mini, Poison, Confuse, Blind, Silence

Tip: Status protection abilities are highly recommended (at least Clear Headed), and Angel's Snack will cure everything he manages to afflict you with. Also useful is water protection equipment (Glass Armlet, Diamond Gloves, Ribbon).
Note: This boss gives exp. The Night trick won't work. In fact this boss is immune to all status ailments (except Slow).
---
Note: It's possible to catch more than 99 frogs.

///Shimmering Island///
Basic objective after the scenes: Follow the girl.

Monsters: Hecteyes, Mover, Ring Leader, Worm Hydra
Useful abilities: Antibody, Insomniac, Loudmouth, Bird/Demon/Undead Killer
Note: Hecteyes is undead.
Tip: Monsters here and in the upcoming dungeon use Virus attacks. If you want your other characters to catch up with Zidane's level, consider allowing him to get infected. The exp that he would have gotten goes to the other members of the party. There is no way to prevent Virus, and Vaccine is the only cure.

Treasure:
Stepping Stones (down stairs from Downhill Path)- Coronet
Path by the Pond- Dragon Wrist (from Stepping Stones), Elixir (on ledge)
Treetop- Remedy (lower right), Mythril Racket (hidden to left)
Tree Base- Demon's Vest
???- Minerva's Plate (lower left of screen, down from hidden path)

///Bran Bal///
Basic objective: Go to the room on the left, then to the laboratory.

Storage (left of Pond)- Elixir
Storage (right of Pond)- Wing Edge, moogle (Moorock), Stiltzkin
 Mognet: from Moorock to Mozme
Stiltzkin item set 7: Diamond, Ether and Elixir for 2222 gil
Gate (under bridge)- Flash Hat

New equipment: (mogshop)
Defender          9340
Holy Lance       11000 (if you didn't steal it at Oeilvert)
Avenger          16000 (if you didn't steal it at the Earth Shrine)
Flash Hat         5200 (can find one soon)
Adaman Hat        6100
Platinum Helm     4600
Platina Armor    10500

Ability note: Thunder Slash (Defender) misses often.
    Dragon's Crest (Holy Lance) is like Frog Drop and Thievery in that it does consistent damage and never misses. The formula is:
Damage = (number of dragons killed)^2
Freya need not be in the party for a killed dragon to count towards to total. In order for it to reach 9999 damage you will have to slay 100 dragons.
    Demi Shock (Avenger) is similar to Demi, but only takes off 20% of the target's max HP.
ATE: After the control switches to Eiko, you can be sure to see all the ATE's by following Zidane's path. You can talk to the other characters to get extra dialogue but it actually won't matter whether they join you.

///Pandemonium///
Basic objective: Follow the trail. There will be a number of event battles.

Monsters: Amudusias, Abadon, Malboro, Mover, Shell Dragon
Useful abilities: Bird/Bug/Demon Killer/Dragon Slayer, wind and earth protection
New blue magic: Twister (Abadon; if you missed it at Mount Gulug)
Note: You can Eat Abadons, but not the one in the event battle.

Treasures:
Hall (start)- moogle (Moorock)
Mind Control (up from Hall)- Holy Miter (under chair)

***
Puzzle: The monster generator (Medium)
    When you get to the Generator room, there will be a switch that simultaneously turns on the bridge outside and starts the light sequence on the floor, for 30 seconds. If you touch one of the lights you'll have an encounter and when it's resolved you won't be able to get across the bridge in time. When the time runs out, the bridge will disappear, even if you're standing on it. Suggestion: Watch the lighting pattern and plan your path through the room. Then you can push the button to reset the time when you're ready to go for it.

***
Puzzle: The rotating elevator (Medium- 2 hints)
    The objective is to get to the top. The elevator connects several pairs of boarding points in this vertical room. You can control the initial direction that the platform faces with the switch in the previous room, but it rotates counterclockwise as it moves up. You can't board the platform if it's not facing the boarding point. Note that there's a treasure you can reach in this room with the elevator.

Hint 1: Trial and error can get you to the top.

Hint 2: If you can't board from one point at a certain rotation setting, you may still be able to board at a different point.

Solution: Setting 3 can get you the treasure (top of the room), and setting 4 will bring you all the way up.
***

Elevator- 20007 gil
Maze- Elixir, Carabini Mail (follow the less obvious path to the upper right or left from the top of the Elevator); Battle Boots, moogle (Mozme) (obvious path down from Elevator)

Ability note: Initiative (Battle Boots) is very useful (but not as essential as Alert).
---
First boss battle at Pandemonium
Lv 58
Type: Dragon
HP/MP: 24,055/9,999
Gil/AP: 5,240/
Steal: Elixir, Dragon Mail, Kaiser Knuckles
Weak: Ice, Wind        Guard: Earth
Abilities: Claw, Twister, Shockwave, Aerial Slash

Tip: Wear wind protection.
---
Second boss battle at Pandemonium
Lv 62
Type: Human
HP/MP:40,728/9,999
Gil/AP: 0/0
...
Weak: none
Abilities: Wave, Flare, Psychokinesis, Stop

Note: This boss will not cast Flare or Stop on a reflected character.
---
Third boss battle at Pandemonium
Lv 64
Type: Human
HP/MP: 42,382/9999
Gil/AP: 0/0
...
Weak: none
Abilities: Demi, Thundaga, Flare Star

Tip: If all of your characters have Reflect status, he will cast nothing but Flare Star (which hurts). However, if gave Auto-Reflect to three characters, he will cast only the other two spells, and only on the unreflected member. You can exploit this behavior by giving that character the Coral Ring.
---

***Disk 4***

///Invincible///
Basic objective: Fly to the Iifa Tree. There are more sidequests available now.
Note: Unlike the other one, this airship can land on brown or green ground (but still not forest or beach).

Treasure:
Core- Pisces (key item)

+++
Side quest: Dead Pepper treasures
    If you found all the other Dead Papper treasures and return to Chocobo's Paradise and talk to Fatty with the square button, he will tell you about the final Dead Pepper treasure. It's in the ocean exactly where he says it is, but you can't see anything on the surface. Use the marker that's still on your map to position yourself and then dive for it. Afterwards, if you return he'll give you a rare Fat Chocobo card. At this point he will also give you back any cards you found with Choco that you had to leave behind.

+++
Side quest: Chocobo beaches
    After finding the final Dead Pepper treasure and seeing the scene at Chocobo's Paradise, you can return to Fatty again and he will tell you to bring Choco to all the beaches of the world. The objective is to press circle standing at every beach of the world. You should hear a tone at each one. You actually don't need to have Choco around; it's probably quicker to use the airship. If you do this quest I recommend you find them all at once so you don't lose track. Not all beaches count toward the total because only one beach counts per place name; e.g., the Falstead Coast only counts once. You'll get a message when you find all of them, and from now on if Zidane is standing on a beach with Choco you get HP/MP restored by pressing circle.

Region           Beaches
Mist Continent         7
Outer Continent        7
Salvage Archipelago    4
Lost Continent         2
Forgotten Continent    0

+++
Side quest: Madain Sari
    In the kitchen in Madain Sari, you'll find a certain someone. If you bring a party that includes both Dagger and Eiko, she will run away. Then if you bring a party that includes neither Dagger, Eiko nor Amarant, she will tell you about something in the secret room. (She only says this if you previously brought the Dagger-Eiko party.) You can now read a clue in the secret room. Now you have to figure out the meaning of this clue.
***
Puzzle: Madain Sari (Hard)    Reward: extra insight into the story

Clue: Time moves forward once; Time moves backward once; Nine is the first number; It is also the last.

Hint 1: Try the Eidolon wall. Notice the new camera angle here. You can read some of the sites on the wall.

Hint 2: "Forward once... backward once..."

Hint 3: Zidane already figured out what is meant by forward and backward.

Hint 4: Try walking to the right at the wall. Listen carefully.

Hint 5: Nine is the important number. "First" and "last" don't really mean anything though.

Hint 6: If you thought of walking around the wall nine times, you're on the right track.

Solution: Walk around the wall, alternating right then left a total of nine times. You should hear an odd tone for each correct circling. You'll know it when you're done because you will get free healing.
***
Now you can read all of the sites on the wall. There is one important site that you can read only when you've read all the others.

+++
Side quest: The Final Stellazzio (Hard- 6 hints)    Reward: Hammer
    Now you should have Aquarius and Pisces, to turn in for 30000 gil and a Robe of Lords. That should be twelve. If you missed any of them you can get them at your liesure now. After you turn in the 12th one, you will become aware of another. The writings on the coins (which you are allowed to see again) are the hints to the location of number 13.

Hint 1: "...headed east..." "...in the opposite direction of the sun." We're talking the east part of the world map.

Hint 2: "Through the forest and over the mountain..." Okay, not very helpful but there are forests and mountains nearby.

Hint 3: "...by the river." "...chilly northern wind..." These are duds. No river, no snow close by.

Hint 4: "...to the cape where Virgo waited. The sun was setting into the ocean." "Waiting for the sun to set into the ocean." "Watching the sunset from the cape..." "...up a hill toward the sun..." Up a hill. Sunset. Cape. Ocean. Get it?

Hint 5: It's not far from Treno.

Hint 6: It's located where you found one of the twelve.

Solution: It's in the same place where you found Scorpio, Quan's Dwelling.

Note: The hammer cannot be equipped. It is a one of a kind rare item that is a component in some synthesis formulas. If you have it in your inventory at the end of the game there is a miniscule change in the ending sequence.

+++
Side quest: Knight's House (Medium)        Reward: Circlet
    That's a Behemoth down there. Now things are interesting because of his devastating Meteor Counter. There are several ways to deal with it. You can hit him with extreme power moves (e.g., Shock) and hope that he won't counter before you kill him (or that the counter won't kill you). You can disable his counter by Silencing him with one of the white mages or with Soul Blade on the Butterfly sword, then killing him with Holy, summons or Thievery. You can avoid the counter entirely by using Counter and Eye 4 Eye yourself, (along with Beast Killer, MP Attack, Distract, Auto Regen and whatever else you can afford) and then just Defending. Or you can gamble it with Quina's Roulette or Vivi's Stop, Break or Death. Actually the easiest method is just Soul Blade with the Sargatanas (Petrify).

Lv 71
Type: Beast
HP/MP: 24,123/3,338
Gil/AP: none for this battle
Steal: Phoenix Pinion (4)
Weak: Ice
Abilities: Strike, Meteor Counter, Horn

+++
Mini game: The auction house
    It's now possible to get the Magical Fingertip key item for ~35000 gil. To get it to appear, make sure you've sold each of the four key items that are available at the auction to the buyers in town. (Whether you bought them a second time makes no difference as long as you sold them.) When you have the Fingertip, bring it to the old man on the second floor of Daguerreo. And while you're there:

New equipment: (weapon shop)
Ultima Sword    14000 gil
Power Wrist      5100
Aegis Gloves     7000
Kaiser Helm      7120
Ninja Gear      14000 (if you didn't steal it at Pandemonium)
Dragon Mail     14000 (if you didn't steal it at Pandemonium)

Ability note: Eye 4 Eye (Kaiser Helm, Ninja Gear) actually makes Counter useful.

+++
Side quest: Mognet (Medium)    Reward: Protect Ring
    If you head back to Kupo in Alexandria now, he will start a chain of Mognet letters. You can get a Kupo Nut for every one of these that you deliver. Moguta will give an Aloha T-Shirt for the first Kupo Nut you give him in disc 4. The trick is remembering where each moogle is. I will give one hint for each before giving the location. Note that, contrary to rumor, it was not possible to do this quest in disc 3. Also at the Steeple is Stiltzkin, with the final item set.

Stiltzkin item set 8: Moonstone, Ruby and Elixir for 5555 gil
Note: If you bought every item set, you get a Ribbon now.

from Kupo to Atla

Hint: Stiltzkin was with Atla when he offered his first item set.

Location: She's at Burmecia, in the Vault.

from Kupo to Mogryo

Hint: Stiltzkin wrote Mogryo a letter about "Rally-Ho".

Location: He's at the Black Mage Village. And while you're here:

New equipment: (weapon shop)
Wizard Rod        3990 gil
Siren's Flute    7000
High Mage Staff    6000 (if you didn't get chocograph 14)
Thief Hat        8300
Dark Gear        16300 (if you didn't steal it at Pandemonium)

New equipment: (synthesist)
Masamune           16000 gil
Duel Claws         16000
Priest's Racket    11000
Bracer             24000
Gauntlets           8000 (if you missed the Gold Chocobo's treasure)
Golden Skullcap    15000
Grand Helm         20000
Rubber Suit        20000 (if you didn't steal it at the Earth Shrine)
Brave Suit         26000
Grand Armor        45000 (can steal one soon)

Ability note: The purpose of Dispel (Siren's Flute) is to remove helpful effects from the enemy, not to cure harmful effects from your party. It does cure Slow, however.
    Esuna (Siren's Flute) cures Confuse, Poison, Sleep, Heat, Freeze, Mini, Gradual Petrify, Silence and Darkness.
    Power Throw (Bracer) makes Throw much more useful.
    Power Up (Golden Skullcap) makes Chakra much more useful.
Tip: Soul Blade with the Masamune (Doom) will end almost any monster.
Note: If you go to the Rooftop again you can overhear another conversation.

+++
Side quest: Doga and Une    Reward: nothing
    If you bring Doga's Artifact and Une's Mirror to the music player at the inn you will hear a theme that may be familiar.
+++

from Mogryo to Kumool

Hint: He's on the Forgotten Continent.

Location: He's in Ipsen's Castle.

from Kumool to Mois

Hint: Mois was originally at the Ice Cavern but that's closed off now.

Location: He's at the entrance of Fossil Roo. Okay, so that one was unfair.

from Mois to Noggy

Hint: He's on an island.

Solution: He's at Daguerreo.

from Noggy to Kupo

After delivering to Kupo, you will have to find out who in Alexandria has the item. (3 hints)

Hint 1: Think of what Artemicion used the item for.

Hint 2: There's someone in town with fur like Artemicion's.

Hint 3: Actually hair, not fur.

Solution: Speak to Ruby at the theater.

After getting the item, just bring it to Mognet Central to finish the quest. Its location is described by the Reef chocobo at Chocobo's Paradise. (See "Dead Pepper Treasures" above if you haven't found it yet.)

+++
Side quest: Vile island (Medium)    Reward: tons of exp
    On the island southwest of the Iifa Tree, you'll encounter Yans. They are hard to kill and give lots of exp. One to three of them may show up at a time. Here's their information:

Lv 72
Type: none
HP/MP: 19,465/3378
Gil/Exp: 2218/42673
Steal: Ore, (none), (none), Elixir
Weak: Shadow    Half: Holy
Abilities: Snort, Comet, Aera, Float, Virus Powder

Tip: Soul Blade with the Masamune works well.
Note: If you want to make progress on Freya's Dragon Crest ability, it's better to fight Grand Dragons. They give less exp per battle but they are much easier to kill.

Friendly monster: (Vile Island)
Yan- asks for Diamond, gives 50 AP, Rosetta Ring
+++

///Iifa Tree///
Basic objective: Enter the glowing light.
...
HP/MP: 54,940/9,999
Gil/AP:   9,506/13
Steal: Remedy, Dragon Wrist, (none), Grand Armor
Abilities: Counter, Twister, Shockwave, Tidal Wave, Psychokinesis, Aerial Slash
Weak: Ice, Wind        Guard: Earth
...
///Memoria///
Basic objective: Get to the end. This is the last dungeon.

Monsters: Ash, Chimera, Iron Man
Useful abilities: Antibody, Body Temp, Locomotion, Bird/Demon Killer/Man Eater, ice protection
New blue magic: Frost (Chimera)
Tip: All of these monsters can easily be dispatched with Soul Blade on the Masamune (Doom). The Ash, however, is a player hater and will counter with Death when Doomed.

Treasure:
Entrance- exit point to airship, save point/party change, Kain's Lance (behind wall on upper right)
Stairs of Time- Master Phantom card player (at field icon to lower left)
Recollection- The Tower (on balcony at top level)
Outer Path- boss battle without warning

---
First boss at Memoria
Lv 72
Type: Demon
HP/MP: 59,497/3,381
Gil/AP: 8,532/10
...
Abilities: Sword Quiver, Firaga, Raining Swords, Flame Slash, Mustard Bomb, Esuna, Reflect
---

The Past- Angel Flute (left of monument), save point/party change (right of monument)
Recollection- Defense Phanton (at field icon to left)
Time Interval- Rune Claws (left side), boss battle without warning

---
Second boss at Memoria
Lv 72
Type: Dragon
HP/MP: 59,494/3,381
Gil/AP: 8,820/10
Steal: Blood Sword, Feather Boots, (none), Grand Helm
Weak: Ice    Absorb: Wind
Abilities: Twister, Absorb MP, Absorb Magic, Float, Snort, Jet Fire, Absorb Strength, Silent Claw

Note: Jet Fire causes Heat to all members. Silent Claw inflicts Silence. Snort removes a member from the battle.
---

Lost Memory- Strong Phantom (at field icon)
Portal- save point/party change
 Monsters: Behemoth, Iron Man, Stilva
 Useful abilities: Beast/Demon Killer/Man Eater
Birth- secret boss (behind rocks to right; There's no field icon)

---
Secret boss at Memoria
Lv 92
Type: Demon/Flying
HP/MP: 55,535/9,999
Gil/AP: 9,638/30
...
Abilities: Powering Sword, Freeze, Cleave, Doomsday, Reflect, Curse, Mustard Bomb
Weak: Holy        Guard: Earth    Shadow: Absorb

Note: This boss gives exp. Curse causes Poison, Confusion, Darkness, Mini, and Slow. Doomsday does Shadow damage to all members. There is a special reward after this fight
---

New equipment: (synthesist)
Robe of Lords    30000 (more than one available from side quests)
Tin Armor        50000
Protect Ring     40000 (more than one available from side quests)
Pumice           50000
Pumice Piece     25000
Save the Queen   50000
Pumice Piece     25000
Phoenix Pinion     300
Ether              500
Note: If you want a Pumice but don't want to synthesize one and lose your Pieces, you can get one in the Ozma sidequest. (see below)

Ocean- Boss battle without warning

---
Third boss battle at Memoria
Lv 72
Type:  Demon
HP/MP: 59,496/3,380
Gil/AP:   17,376/10
Weak: Thunder    Half: Ice    Absorb: Water
Steal: Genji Helmet, Wizard Rod, (none), Glutton's Robe
Abilities: Leg, Waterga, Ink, Water-Gun, Freeze, Esuna
---

Time Warp- save point/party change (hidden at balcony, lower level), Rare Phantom (upper balcony at field icon)
Stairs- Mace of Zeus (upper left of platform), Dark Phantom (upper right of platform at field icon)
 Ability note: Doomsday (Mace of Zeus) hits all targets in combat. You can use this to your advantage by equipping Shadow-absorbing equipment.
Gate to Space- boss battle without warning

---
Fourth boss at Memoria
Lv 71
Type: Demon
HP/MP: 58,554/9,999
Gil/AP: 8,436/10
Steal: Genji Gloves, Siren's Flute, Black Robe
Weak: Fire, Wind, Holy    Half: Shadow    Absorb: Earth
Abilities: Death Cutter, Earthquake, Stop, Venom Powder, LV5 Death, Doom, Death

Note: This boss is not undead.
---

Gate to Space (after boss battle)- save point/party change (hidden to left), Excalibur II (hidden to right)

+++
Side quest: Excalibur II (Expert)
    You will be able to get the Excalibur II in this room only if you got to this point within 12 game hours. Refer to the "Excalibur II FAQ (JP)" by Etoh-21/SNOWS-san for tips.
+++

New monsters: Maliris, Tiamat, Kraken, Lich

Crystal World (4th screen)- save point/party change/teleport
Note: The Teleport to the entrance is one-way; you will have to walk all the way back if you use it.

+++
Side quest: Ozma (Difficult)    Reward: Ozma card, Strategy Guide (key item)
    If you go to Chocobo's Air Garden and examine the thing on the smaller island, you can fight the hidden boss. It's possible to do this as early as getting gold Choco, but I've put the information here because you'll probably want the equipment from Memoria before fighting him. There has been a lot of ink spilled over this boss, mostly hype. I will lay out some facts. From there you can put together your own strategy. Here's his information:
---
Lv 99
Type: Flying
HP/MP: 55,535/9,999
...
Abilities: Doomsday, Flare Star, Curse, Flare, Mini, Berserk, Death, LV 4 Holy, LV 5 Death, Meteor, Curaga
---
1. If you completed the Friendly Monster side quest Ozma will be much easier because he will be hurt, not healed, by the Shadow damage of his Doomsday. In fact he becomes weak against Shadow. Also, without the side quest you will be unable to hit him with ordinary physical attacks. I don't recommend fighting him without having done the side quest. Look at it this way: you can finish the side quest in less time than it would take to prepare to fight him in his stronger state.
2. Your characters do not have to be at lv 99. If you're an RPG player who gets off on leveling everyone to the max level, that's fine but note that it's not necessary. I fought Ozma at around level 50, jacked all his stuff over the course of about ten rounds, then jacked his ass in about ten more rounds. You can do it if you know what you're doing. His Dark Matter and Pumice Piece are rare items.
3. His Doomsday can be easily dealt with by giving everyone Shadow equipment, preferably Shadow absorbing. (e.g., Pumice Piece, Ninja Gear, Demon's Mail) You can avoid LV4 Holy and LV5 Death by coming to battle at levels incompatible with these spells. You can avoid Flare, Mini, Berserk and Death with Auto-Reflect, but that's a lot of magic stones, and then if you bring a healer you'll want to also give her Reflect Null. You may just want to take these spells head on to avoid having to spend the stones on Auto-Reflect. All the ailments that Curse causes (Poison, Confusion, Darkness, Mini, Slow, plus damage) can be prevented except Mini, and all of them except Confuse and Slow are curable with Remedy (preferably Angel's Snack). At the very least you'll want to give Auto-Haste, Antibody and Clear Headed to everyone. That leaves Flare Star and Meteor; These two just plain hurt. They may do over 4000 damage, killing your weaker characters instantly (but don't let this deter you from using the weaker charcters.) He counters actions targeted at him with either Meteor or Curaga. He counters more than half the time.
4. Now let me remind about the mechanics of combat: Ozma is about as fast as an enemy can get, but you can still get two moves for every one of his. If you have two commands entered before his spell animation ends, you get to do both without interruption (though he may counter). But if you enter one then the other while the first is going on, he'll get to go in between.
5. Since you can get at most two moves at a time, it is pointless to bring more than two power characters. In fact it may be better to bring just one so that the rest of the party can focus on support. Vivi and Steiner should be ready even at low levels to deal 9999 damage per turn (Flare with Reflect X2 and Shock); Freya, Quina and Zidane can do it with training (Dragon Crest, Frog Drop, Thievery). Since you want a party with a lot of HP, Steiner is probably the default choice in this department but it's up to you. If you want the power of Shock without having to stop to replenish Steiner's MP, try using Darkside. It should do max or nearly max damage if you completed the friendly monster sidequest.
6. You may want to bring a healer because Curaga and Life or Full Life will be useful. The automatic Revival Flame of Phoenix may make the difference between winning and losing. Or you can bring someone with more HP and just use Elixirs and Phoenix Downs to heal. In any case Auto Regen is, as always, very handy.
7. Some recommend killing his MP with Magic Hammer to disable Curaga and some of his annoying spells, but if you do this he won't be able to hurt himself with Doomsday. This is also an investment of several turns which could be spent otherwise.
8. Some recommend getting certain characters ready to Trance (with High Tide) to improve their abilities in the battle. This may or may not be worth the trouble for you.
+++

Back at Memoria:
---
Fifth boss at Memoria
Lv 74
Type: Demon/Bug/Flying
HP/MP: 55,535/9,999
Gil/AP: 8,916/0
Steal: Elixir, Black Belt, (none), Duel Claws
Abilities: Demon's Claw, Meteor, Death, Spin, LV5 Death, Twister
Weak: Ice, Wind    Guard: Earth

Note: You can still save or leave after this battle.
---
Sixth boss at Memoria
Lv 76
Type: Human/Flying
HP/MP: 55,535/9,999
Gil/AP: 0/0
Steal: Ether, White Robe, (none), Rebirth Ring
Abilities: Flare Star, Holy, Curaga, Reflect
Weak: none

Tip: Prepare for the next battle as well before fighting this one.
---
Final boss at Memoria
Lv 69
Type: Flying
HP/MP: 54,100/9,999
Gil/AP: 0/0
Steal: Elixir (3)
Abilities: Grand Cross, Blue Shockwave, Neutron Ring, Protect, Shell, Holy, Flare, Curaga
Weak: none

Note: Grand Cross inflict Confusion, Doom and Stop.
---
After the final battle:

Mini game: Blackjack    Reward: nothing
    At the "The End" screen, press R2,L1,R2,R2,up,X,right,circle,down,triangle,L2,R1,R2,L1,square,square. You should hear a tone. Then press start to play.

End of walkthrough.

+++
Appendix: Friendly monsters

Mu (Nolrich Heights; Dali)- asks for 1 Ore, gives 10 AP, Potion
Ghost (Bentini Heights; Treno)- asks for 1 Ore, gives 10 AP, Hi-Potion
Ladybug (Donna Plains; Conde Petie)- asks for 2 Ores, gives 20 AP, Ether
Yeti (Lucid Plains; Madain Sari)- asks for 2 Ores, gives 20 AP, Elixir
Nymph (Pualei Plains; Iifa Tree)- asks for 3 Ores, gives 30 AP, Emerald
Jabberwock (Blairsurpass Plains; Forgotten Continent)- asks for Emerald, gives 40 AP, Moonstone
Feather Circle (Milmakis Ice Field; Lost Continent)- asks for Moonstone, gives 30 AP, Lapis Lazuli
Garuda (Popos Heights; above Gizamaluke's Grotto)- asks for Lapis Lazuli, gives 40 AP, Diamond
Yan (Vile Island)- asks for Diamond, gives 50 AP, Rosetta Ring

+++
Appendix: Chocograph treasures

1: 2 Elixirs, 3 Hi-Potions, 4 Ethers, 2 Germinas Boots
2: 5 Potions, 5 Hi-Potions, 2 Tents, 2 Cotton Robes
3: 10 Antidotes, 1 Jade Armlet, 3 Wing Edges, 1 Cargo Ship card
...
11: 4 Remedies, 2 Elixir, 8 Rising Suns, 1 Oak Staff
12: upgrade to Mountain chocobo
...
20: upgrade to Sky chocobo
21: 21 Amethysts, 16 Garnets, 1 Genji Armor, 1 Ragnarok
22: 11 Sapphires, 1 Circlet, 1 Pumice Piece, 1 Hilda Garde 3 card
23: 33 Potions, 15 Annoyntments, 1 Holy Miter, 1 Dark Matter card
24: 1 Ribbon, 1 Rebirth Ring, 13 Amethysts, 1 Ark card

+++
Appendix: Dead Pepper treasures

Reef chocobo's treasures
Crack: Mognet Central
Foam: 8 Straw Hats, 8 Pearl Armlets, 7 Aloha T-Shirts, 8 Sandals
Mountain chocobo's treasures
